...
* **xmltv:** a multi-part episode's `onscreen` value is now `S02E06 P1/2` rather than `S02E06 (1/2)`. The old spelling was this package's alone, and it claimed something it did not mean: a parenthesised `n/m` after an episode number is episode *n of m* in every emitter that writes one. `P` is WebGrab+Plus's documented part marker and the only spelling that says "part".
...
* **cli:** --profile, and a validator that notices it changed ([1c9d7b3](https://github.com/Ruby184/epg-tools/commit/1c9d7b3b37def6ca520823c012f1c6097001a527))
...
* output profiles — shape one guide for the consumer that reads it ([3f762e9](https://github.com/Ruby184/epg-tools/commit/3f762e924fefb1ee2acc114c9cc4c0d07b70c5ff))
...
* **xmltv:** alias the genre vocabularies the big upstream feeds write ([6920ae9](https://github.com/Ruby184/epg-tools/commit/6920ae9838cc3a4ada3ce52d21893211561eb8bc))
* **xmltv:** apply the output profile as a document is written ([cc5d02f](https://github.com/Ruby184/epg-tools/commit/cc5d02fcd402b9c2617d3f8dfb23be202c52e7f8))
...
* **xmltv:** output profiles, and the two that were read from source ([6333568](https://github.com/Ruby184/epg-tools/commit/633356823c0f52f583412b9bcbee2d373eb516c8))
* **xmltv:** read the episode-num systems, not just write them ([181062b](https://github.com/Ruby184/epg-tools/commit/181062b9f473d975322c107ecc121e12b28642dd))
* **xmltv:** ship the DVB genre vocabulary ([a76a612](https://github.com/Ruby184/epg-tools/commit/a76a612022f1ca7fbdf735673b0edd7deeb8136c))
...
* **cli:** rewrite ids without reformatting the file around them ([d6fadff](https://github.com/Ruby184/epg-tools/commit/d6fadff63b83064109c7a21c8bc87b08f0534fae))
...
* **serve:** honour the channels the config asks for ([d24277f](https://github.com/Ruby184/epg-tools/commit/d24277f0c541f5105ccfce85adb50cba73946a66))
...
* **xmltv:** make an unprofiled guide cost nothing, and a profiled one less ([a69d193](https://github.com/Ruby184/epg-tools/commit/a69d19330c2f021df7f54a6002c3b988d0855048))
...
* **xmltv:** one bag for the output-shaping options ([7059225](https://github.com/Ruby184/epg-tools/commit/70592255a6014e01d826b3c0e90d56e644b3da01))
